...
multicast_communication::quote_message::quote_message(std::string _security_symbol, double _bid_price, double _bid_volume, double _offer_price, double _offer_volume) : 
	_security_symbol(_security_symbol), _bid_price(_bid_price), _bid_volume(_bid_volume), _offer_price(_offer_price), _offer_volume(_offer_volume)
{
