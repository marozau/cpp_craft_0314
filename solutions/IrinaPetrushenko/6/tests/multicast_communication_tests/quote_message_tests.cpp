...
void multicast_communication::tests_::quote_message_tests()
{
	...
	{
		std::string ss("EO A  003759032T:J_073ADMR  B00004147006 B00004148004 12");
	...
	{
		std::string ss("EO A  004393884N:Jb295EMN             0    AAAR AD0000007929000000001D0000007941000000001     A   02");	
		quote_message_ptr qm =quote_message_ptr(new quote_message (ss,LONG_Q));
	...
	{
		std::string ss("EO A  003759033T:J_073ADMR  B00004147001 B00004148004 62KB00004147005 TB00004148004 ");	
		quote_message_ptr qm =quote_message_ptr(new quote_message (ss,SHORT_Q));
