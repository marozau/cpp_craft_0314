...
ext_stock_data::ext_stock_data( std::ifstream& in )
{
...
ext_stock_data::ext_stock_data( const char* stock_name,
...
ext_stock_data::~ext_stock_data()
{

}

void ext_stock_data::write( std::ofstream& out ) const
{
...
void ext_stock_data::write_raw( std::ofstream& out ) const
{
